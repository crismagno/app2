            ...
            <div className={"d-flex justify-content-between align-items-center"}>
                <h1 className="d-flex  align-items-center text-center">
                    ...
                    <div className="d-flex flex-column  justify-content-start align-items-start">
                        <span style={{fontSize: 13, color: props.colorUserName}} className={`mx-1`}>
                            <i>[ {props.userName} ]</i>
                        </span>
                ...
                <button 
                    ...
                    className={`btn ${props.hoverRemoveAllMessages && "btn-outline-danger" || "btn-outline-light border-none"} d-flex align-items-center shadow`}> 
